...
public class JsonMocker {
    ...
    private RanOpt[] eventOpts = {new RanOpt("addFavor", 10), new RanOpt("addComment", 30),new RanOpt("addCart", 20), new RanOpt("clickItem", 5), new RanOpt("coupon", 45)};
    ...
    private String initStartsupLog() {
        ...
        String mid = "mid_" + RandomNum.getRandInt(1, 700);
